package tests.lineales;//EDITADO

import lineales.dinamicas.Pila;//OK
//import lineales.estaticas.Pila;//OK
...
public class TestingPila {
    /**Descargar la clase TestingPila
*Deberán ejecutar la clase TestingPila entregada por la cátedra y asegurar que pasa OK todos los casos de prueba. 
* La clase TestingPila deberá ser utilizada sin cambiar nada del código original, tanto para la clase Pila del paquete estáticas como para la del paquete dinámica. 
* Para que el testing funcione correctamente las pilas estáticas a testear deben tener un tamaño de 10. 
* Solamente se podrá cambiar la línea del import para cambiar el paquete a probar.
*Subir un archivo (Apellido+Nombre) en formato zip o rar conteniendo las clases Pila estática y Pila dinámica. La tarea está en el apartado de TPs Obligatorios.
* **/
